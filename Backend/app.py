...
# Initialize Flask
app = Flask(__name__)
CORS(app, resources={r"/predict": {"origins": ["http://127.0.0.1:5500", "http://localhost:5500"]}}, supports_credentials=True)
    ...
    try:
        ...
        if os.path.exists(temp_img_path):
            try:
                ...
                logger.debug(f"Temporary image {temp_img_path} removed")
            except Exception as e:
